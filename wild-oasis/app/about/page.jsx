...
export default function Page() {
    return (
        <div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
            ...
            {/* Example of an Static image being imported. Don't have to specify H x W, can add placeholder and quality attributes */}
            ...
            {/* Example of image that's size is being set by parent container */}
